...
class PengirimanBarang {
    ...
    double biayaDasar;
    int jarakPaket;
    PengirimanBarang() { //deklarasi awal
        namaPengirim = "";
        alamatTujuan = "";
        berat = 0;
        biayaDasar = 0;
    ...
    void hitungOngkir(int jarak) {
        ...
        if (jarak > 50) {
            ...
            System.out.println("Error: Jarak tidak boleh 0.");
        } else {
    ...
    void displayInfoLogistik() {
        System.out.println("---Status paket xX_AmbaExpress_Xx---");
...
class PengirimanBarangf {
    private String namaPengirim;
    private String alamatTujuan;
    private double berat;
    private double biayaDasar;

    public PengirimanBarangf() {
        this.namaPengirim = "";
        this.alamatTujuan = "";
        this.berat = 0.0;
        this.biayaDasar = 0.0;
    ...
    public PengirimanBarangf(String namaPengirim, String alamatTujuan, double berat, double biayaDasar) {
    ...
    public static void displayInfoLogistik() {
        System.out.println("Perusahaan Logistik XYZ - Cepat, Aman, Terpercaya");
    }
